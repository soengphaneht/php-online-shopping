...
<div class="container">
  ...
  <div class="row">
    ...
    ?>
      ...
      <?php
      $qt=mysqli_query($con,"select welcome_title_".$_SESSION["lang"]." from table_homepage");
      $row=mysqli_fetch_array($qt,MYSQLI_NUM);
      echo $row[0];
      ?>
    </h3>
  		<p>
        <?php
        $qt=mysqli_query($con,"select welcome_content_".$_SESSION["lang"]." from table_homepage");
        $row=mysqli_fetch_array($qt,MYSQLI_NUM);
        echo $row[0];
        ?>
      </p>
